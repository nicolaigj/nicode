		...
		if (msg.$ === 'LinkClicked') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						page: $author$project$Main$fromUrl(url),
						url: url
					}),
				$elm$core$Platform$Cmd$none);
		}
...
var $author$project$Main$colors = {
	darkPurple: $rtfeldman$elm_css$Css$hex('282A36'),
	green: $rtfeldman$elm_css$Css$hex('32D97B'),
	pink: $rtfeldman$elm_css$Css$hex('F25169'),
	white: A4($rtfeldman$elm_css$Css$hsla, 301, 0.71, 0.96, 1.0)
};
...
var $author$project$Main$contentArea = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, 'grid-area', 'content'),
			$rtfeldman$elm_css$Css$fontSize(
			$rtfeldman$elm_css$Css$rem(1.375)),
			$rtfeldman$elm_css$Css$color($author$project$Main$colors.white)
		]));
...
var $author$project$Main$bracketStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$color($author$project$Main$colors.pink),
...
var $author$project$Main$headerArea = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Main$navLayout = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			...
			A2($rtfeldman$elm_css$Css$property, 'grid-template-columns', '1fr minmax(200px, 500px) 2fr'),
			A2($rtfeldman$elm_css$Css$property, 'grid-template-areas', '\'gutterLeft header gutterRight\''),
			$rtfeldman$elm_css$Css$backgroundColor($author$project$Main$colors.darkPurple)
		]));
		...
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Main$headerArea]))
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[$author$project$Main$navItemStyle]))
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$Attributes$css(
											_List_fromArray(
												[$author$project$Main$bracketStyle]))
										]),
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text('{')
										])),
									$rtfeldman$elm_css$Html$Styled$text('Nicode'),
									A2(
									$rtfeldman$elm_css$Html$Styled$span,
									_List_fromArray(
										[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$href('/#/cv'),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[$author$project$Main$navItemStyle]))
								]),
...
var $author$project$Main$pageLayout = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, 'display', 'grid'),
...
var $author$project$Main$heroLayout = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, 'display', 'grid'),
			A2($rtfeldman$elm_css$Css$property, 'grid-template-columns', 'repeat(auto-fill, minmax(200px, 500px))')
		]));
...
var $author$project$Main$heroImageStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Main$heroLeft = A2(
	$rtfeldman$elm_css$Html$Styled$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$src('/assets/nicolai.jpg'),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Main$heroImageStyle]))
				]),
			_List_Nil)
		]));
...
var $author$project$Main$heroTextStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			...
			$rtfeldman$elm_css$Css$marginBottom($rtfeldman$elm_css$Css$auto),
			$rtfeldman$elm_css$Css$fontSize(
...
var $author$project$Main$heroRight = A2(
	$rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[$author$project$Main$heroTextStyle]))
		]),
	_List_fromArray(
		[
			A2(
...
var $author$project$Main$pageLoader = function (page) {
	switch (page.$) {
		case 'Contact':
			return _List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$author$project$Main$heroLayout]))
						]),
					_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$author$project$Main$pageLayout]))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[$author$project$Main$contentArea]))
								]),
							$author$project$Main$pageLoader(model.page))
						])),
